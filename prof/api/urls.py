...
from prof.api.views import RegisterApi, Logout_view, Follow_create_view, Follow_delete_view, Following_view, \
    Follower_view
...
urlpatterns = [
    ...
    path('unfollow/', Follow_delete_view.as_view(), name='Follow_delete_view'),
